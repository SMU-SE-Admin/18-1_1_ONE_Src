...
public class todolist extends JFrame{
	...
	public todolist()
	{
		...
		Label.setFont(new Font("µ∏¿Ω",Font.PLAIN,30));
		...
		Label1.setFont(new Font("µ∏¿Ω",Font.PLAIN,13));
		...
		Label2.setFont(new Font("µ∏¿Ω",Font.PLAIN,13));
		Label2.setBounds(0,200,100,30);
		contentPane.add(Label2);
		
		JLabel Label3 = new JLabel();
		Label3.setText(" øœ∑·ø©∫Œ");
		Label3.setOpaque(true);
		Label3.setFont(new Font("µ∏¿Ω",Font.PLAIN,13));
		...
		JButton Button = new JButton("µÓ∑œ");
		...
		Button.setFont(new Font("µ∏¿Ω", Font.PLAIN, 15));
		contentPane.add(Button);
		JButton Button1 = new JButton("¡æ∑·");
		...
		Button1.setFont(new Font("µ∏¿Ω", Font.PLAIN, 15));
